...
public class GPAcalcstudent {
    ...
    public void generateReport() throws FileNotFoundException{
        PrintStream output = new PrintStream("/Users/noahshelby/Java-2/report"+ getName() +".txt");
    ...
    public void strengthweak() throws FileNotFoundException {
        PrintStream output = new PrintStream("/Users/noahshelby/Java-2/strengths.txt"+ getName() +".txt");
